...
// Asteroids-style physics: very weak gravity toward home, minimal drag
const GRAVITY    = 6      // spring constant — weak pull toward origin
const DRAG       = 0.8    // velocity decay per second (low = coasts like space)
